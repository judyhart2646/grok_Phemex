...
<script type="text/html" id="reward_qty">
    <div style="text-align:right; margin-right: 10px">
        <span>@{{ Number(d.change).toFixed(4)}}</span>
    </div>
</script>
<script>
    layui.use(['table', 'layer', 'form', 'laydate'], function() {
        ...
        var data_table = table.render({
            ...
            ,cols: [[
                ...
                ,{field: 'to_user_name', title: '用户', width: 200, totalRowText: '小计:'}
                // ,{field: 'scene_name', title: '奖励场景', width: 140}
                // ,{field: 'reward_type', title: '奖励类型', width: 90, hide: true}
                ,{field: 'change', title: '奖励数量', width: 110, totalRow: true, templet: '#reward_qty'}
                ,{field: 'memo', title: '奖励说明', width: 400}
                ,{field: 'from_user_name', title: '触发用户', width: 200}
                ,{field: 'timer', title: '奖励时间', width: 170}
            ]],
