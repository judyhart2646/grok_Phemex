                ...
                <div class="layui-tab-content">
                    ...
                    <div class="layui-tab-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="main_theme" value="1" title="浅色" @if (isset($setting['main_theme'])) {{$setting['main_theme'] == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="main_theme" value="0" title="深色" @if (isset($setting['main_theme'])) {{$setting['main_theme'] == 0 ? 'checked' : ''}} @else checked @endif >
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="hy_back_flag" value="1" title="是" @if (isset($setting['hy_back_flag'])) {{$setting['hy_back_flag'] == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="hy_back_flag" value="0" title="否" @if (isset($setting['hy_back_flag'])) {{$setting['hy_back_flag'] == 0 ? 'checked' : ''}} @else checked @endif >
                                </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="tx_fee_flag" value="1" title="百分比" @if (isset($setting['tx_fee_flag'])) {{$setting['tx_fee_flag'] == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="tx_fee_flag" value="0" title="固定额" @if (isset($setting['tx_fee_flag'])) {{$setting['tx_fee_flag'] == 0 ? 'checked' : ''}} @else checked @endif >
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="green_flag" value="1" title="是" @if (isset($setting['green_flag'])) {{$setting['green_flag'] == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="green_flag" value="0" title="否" @if (isset($setting['green_flag'])) {{$setting['green_flag'] == 0 ? 'checked' : ''}} @else checked @endif >
                                </div>
                        ...
                        <!--    <div class="layui-input-block">-->
                        <!--        <div class="layui-input-inline">-->
                        <!--            <input type="radio" name="hy_lx_flag" value="1" title="是" @if (isset($setting['hy_lx_flag'])) {{$setting['hy_lx_flag'] == 1 ? 'checked' : ''}} @endif >-->
                        <!--            <input type="radio" name="hy_lx_flag" value="0" title="否" @if (isset($setting['hy_lx_flag'])) {{$setting['hy_lx_flag'] == 0 ? 'checked' : ''}} @else checked @endif >-->
                        <!--        </div>-->
