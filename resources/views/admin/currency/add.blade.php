            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item {{$result->id == 3 ? '' : 'hide'}}">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="address_omni_back" name="address_omni_back" value="{{$result->address_omni_back}}" placeholder="地址">
                        </div>
                    </div>
                     @if ( $result->id ==3)
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="address_erc_back" name="address_erc_back" value="{{$result->address_erc_back}}" placeholder="地址">
                        </div>
                    </div>
                    @endif
                      @if ( $result->id !=3)
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="trade_flag" value="1" title="打开" @if (isset($result->trade_flag)) {{$result->trade_flag == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="trade_flag" value="0" title="关闭" @if (isset($result->trade_flag)) {{$result->trade_flag == 0 ? 'checked' : ''}} @else checked @endif >
                                </div>
                            </div>
                        </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="share_num_money" name="share_num_money" value="{{$result->share_num_money}}" placeholder="默认一手数量">
                        </div>
                    </div>
                </div>
                <div class="layui-tab-item">
