...
@section('scripts')
    <script type="text/html" id="table-useradmin-webuser">
        ...
        <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="update">修改代理商</a>
        <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="dj">冻结</a>
    </script>
        ...
        function load(parent_id) {
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    , {title: '操作', width: 400, align: 'center', fixed: 'right', toolbar: '#table-useradmin-webuser'}
                ]]
                , page: true
                , limit: 30
                , height: 'full-320'
        ...
        table.on('tool(san-user-manage)', function (obj) {
            ...
            if (event == 'wallet_info') {
                ...
                layer.open({
                    title: '修改代理商'
                    , type: 2
                    , content: '{{url('/agent/user/agent')}}?id=' + data.id
                    // , maxmin: true
                    ,area: ['400px', '400px']
                });
            }else if(event == 'dj'){
                layer.open({
                    title: '冻结'
                    , type: 2
                    , content: '{{url('/agent/user/lock')}}?id=' + data.id
                    // , maxmin: true
                    ,area: ['400px', '400px']
                });
            }
