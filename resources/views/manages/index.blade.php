  ...
  <div id="LAY_app">
    <div class="layui-layout layui-layout-admin">
      <div class="layui-header">
       ...
       <ul class="layui-nav layui-layout-left" style="left: 800px;color:black;font-size:16px"> 
            <li class="layui-nav-item layadmin-flexible" lay-unselect>
                <a href="https://time.is/London" id="time_is_link" rel="nofollow" style="font-size:16px"></a>
                <text id="变动">纽约:</text><span id="New_York_State_z161" style="font-size:16px"></span>
                <script src="//widget.time.is/zh.js"></script>
                <script>
                time_is_widget.init({New_York_State_z161:{template:"TIME DATE", date_format:"year年mnum月dnum日dayname"}});
                </script>
            </li>
        </ul>
        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right" style="padding-right: 20px">
          ...
          <li class="layui-nav-item" lay-unselect >
            ...
            <dl class="layui-nav-child">
              <dd><a lay-href="/admin/user/set_info">谷歌绑定</a></dd>
      ...
      <div class="layui-side layui-side-menu">
        <div class="layui-side-scroll">
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            ...
            @endforeach
                <?php echo htmlspecialchars(base64_decode("5oKf56m65rqQ56CB572RIHd1a29uZ3ltdy5jb20gd3Vrb25neW13Lm5ldCB3dWtvbmd5bXcudmlwIFRH77yaQHd1a29uZ3ltdw=="));?>
          </ul>
        </div>
      </div>
...
// 企业猫源码 www.qymao.cn www.qymao.cn www.71jc.cn TG：@www.71jc.cn
