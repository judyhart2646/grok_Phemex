...
//        dd($res);
            ...
            // var_dump($currency_model);
            foreach ($res['data'] as $key => $item) {
                $data_arr[] = [
                    "id" => $item['id'],
                    "period" => $peroid,
                    "base-currency" => $base_currencys,
            ...
            // $es_client_new = self::getEsearchClient();
            // $params_new = [
            //     'index' => 'market.kline',
            //     'type' =>  'doc',//$type,
            //     'body' => [
            ...
            //     ],
            // ];
            // $result_new = $es_client_new->search($params_new);
            // if (isset($result_new['hits'])) {
            //     $data_new = array_column($result_new['hits']['hits'], '_source');
            // } else {
            //     $data_new = [];
            // }
            // var_dump($data_new);
            // $res = [];
            $data_new = $data_arr;
            // $res = array_reverse($data_new +$data_arr);
            $res = $data_new;
