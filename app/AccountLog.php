...
class AccountLog extends Model
{
    ...
    public function getTransactionInfoAttribute()
    {
        ...
        // return $type1[$balance_type] . $type2[$lock_tpye];
         $type1 = [
            '0' => str_replace('account_log_info.', '', __("account_log_info.无")) . ' ',
            '1' => str_replace('account_log_info.', '', __("account_log_info.资金")) . ' ',
            '2' => str_replace('account_log_info.', '', __("account_log_info.币币")) . ' ',
            '3' => str_replace('account_log_info.', '', __("account_log_info.合约")) . ' ',
            '4' => str_replace('account_log_info.', '', __("account_log_info.期权")) . ' ',
            '5' => str_replace('account_log_info.', '', __("account_log_info.保险")) . ' '
        ];
        $type2 = ['', str_replace('account_log_info.', '', __("account_log_info.[锁定]")) . ' '];
