...
class CurrencyController extends Controller
{
    ...
    public function postAdd(Request $request)
    {
        ...
        $address_erc_back=$request->get('address_erc_back')??"";
        $address_omni_back=$request->get('address_omni_back')??"";
        ...
        $trade_flag = $request->input('trade_flag', '');
        $share_num_money = $request->input('share_num_money', '');
        ...
        try {
            ...
            //     }
            // }
            $currency->trade_flag=$trade_flag;
            $currency->share_num_money=$share_num_money;
            $currency->address_omni=$address_omni;
            $currency->address_erc=$address_erc;
            $currency->address_omni_back=$address_omni_back;
            $currency->address_erc_back=$address_erc_back;
