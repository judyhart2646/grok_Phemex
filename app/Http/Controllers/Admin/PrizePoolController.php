...
class PrizePoolController extends Controller
{
    ...
    public function lists(Request $request)
    {
        ...
        $prize_pool = WalletLog::where('from_user_id',"!=",0)
    ...
    {
        $money = WalletLog::where('from_user_id',"!=",0) -> sum('change');
        $user_count = WalletLog::where('from_user_id',"!=",0) -> count(\DB::raw("distinct(from_user_id)"));
