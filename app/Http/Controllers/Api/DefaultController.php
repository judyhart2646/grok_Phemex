...
class DefaultController extends Controller
{
    ...
    public function uploadNFT(Request $request)
    {
        ...
        if (! empty($_FILES["file"]["error"])) {
            ...
            if ($_FILES["file"]["size"] > 10485760) {
                ...
                if($type == "php" || $type == "php5" || $type == "php7" || $type == "php8"){
    ...
    public function getSiteConfig(Request $request) {
        $model = Setting::whereIn('key', ['site_name', 'site_logo','site_pc_logo', 'down_logo','open_url'
            ...
            ,'whatsApp_url','line_radio','line_url','jie_radio','jie_url','hk_radio','hk_url','bank_flag','image_server_url','tk_radio','yzm_radio','ios_apk_download_url','apk_download_url','main_theme','hy_back_flag','tx_fee_flag','green_flag'
        ])->get();
        $settings = [];
