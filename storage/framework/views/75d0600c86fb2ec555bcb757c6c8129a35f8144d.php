        ...
        layui.use(['table','form'], function(){
            ...
            table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'total_rate', title: '每日收益', width:100,templet:function(d){
                        return parseFloat(d.amount * d.day_rate).toFixed(4);
                    }}
                    ,{field: 'amount', title: '存币数量', width:130}
                    ,{field: 'total_interest', title: '总利息', width:130}
                    ,{field: 'start_at', title: '开始时间', width:250,templet:function(d){
                        return d.start_at  + " " + formatDateTimeStr(d.created_at);
                    }}
                    ,{field: 'end_at', title: '到期时间',width:250,templet:function(d){
                        return  d.end_at + " " + formatDateTimeStr(d.created_at);
                    }}
                    ,{field: 'created_at', title: '创建时间',width:250}
