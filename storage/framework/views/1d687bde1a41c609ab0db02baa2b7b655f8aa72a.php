        ...
        <div class="layui-tab">
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item <?php echo e($result->id == 3 ? '' : 'hide'); ?>">
                        <label class="layui-form-label">充币地址trc20(备用)</label>
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="address_omni_back" name="address_omni_back" value="<?php echo e($result->address_omni_back); ?>" placeholder="地址">
                        </div>
                    </div>
                     <?php if( $result->id ==3): ?>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">充币地址erc20(备用)</label>
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="address_erc_back" name="address_erc_back" value="<?php echo e($result->address_erc_back); ?>" placeholder="地址">
                        </div>
                    </div>
                    <?php endif; ?>
                      <?php if( $result->id !=3): ?>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">充币地址(备用)</label>
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="address_erc_back" name="address_erc_back" value="<?php echo e($result->address_erc_back); ?>" placeholder="地址">
                        </div>
                    </div>
                    <?php endif; ?>
                    <div class="layui-form-item">
                        <label class="layui-form-label">谷歌验证器</label>
                        <div class="layui-input-block">
                            <input type="password" class="layui-input" id="second_pwd" name="second_pwd" value="" placeholder="谷歌验证器">
                        </div>
                    </div>
                </div>
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item">
                            <label class="layui-form-label">是否开启默认下注设置</label>
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="trade_flag" value="1" title="打开" <?php if(isset($result->trade_flag)): ?> <?php echo e($result->trade_flag == 1 ? 'checked' : ''); ?> <?php endif; ?> >
                                    <input type="radio" name="trade_flag" value="0" title="关闭" <?php if(isset($result->trade_flag)): ?> <?php echo e($result->trade_flag == 0 ? 'checked' : ''); ?> <?php else: ?> checked <?php endif; ?> >
                                </div>
                            </div>
                        </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">默认一手数量</label>
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="share_num_money" name="share_num_money" value="<?php echo e($result->share_num_money); ?>" placeholder="默认一手数量">
                        </div>
                    </div>
                </div>
                <div class="layui-tab-item">
