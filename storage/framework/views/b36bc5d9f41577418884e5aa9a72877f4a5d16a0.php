                ...
                <div class="layui-tab-content">
                    ...
                    <div class="layui-tab-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="main_theme" value="1" title="浅色" <?php if(isset($setting['main_theme'])): ?> <?php echo e($setting['main_theme'] == 1 ? 'checked' : ''); ?> <?php endif; ?> >
                                    <input type="radio" name="main_theme" value="0" title="深色" <?php if(isset($setting['main_theme'])): ?> <?php echo e($setting['main_theme'] == 0 ? 'checked' : ''); ?> <?php else: ?> checked <?php endif; ?> >
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">是否开启智能合约赎回</label>
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="hy_back_flag" value="1" title="是" <?php if(isset($setting['hy_back_flag'])): ?> <?php echo e($setting['hy_back_flag'] == 1 ? 'checked' : ''); ?> <?php endif; ?> >
                                    <input type="radio" name="hy_back_flag" value="0" title="否" <?php if(isset($setting['hy_back_flag'])): ?> <?php echo e($setting['hy_back_flag'] == 0 ? 'checked' : ''); ?> <?php else: ?> checked <?php endif; ?> >
                                </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="tx_fee_flag" value="1" title="百分比" <?php if(isset($setting['tx_fee_flag'])): ?> <?php echo e($setting['tx_fee_flag'] == 1 ? 'checked' : ''); ?> <?php endif; ?> >
                                    <input type="radio" name="tx_fee_flag" value="0" title="固定额" <?php if(isset($setting['tx_fee_flag'])): ?> <?php echo e($setting['tx_fee_flag'] == 0 ? 'checked' : ''); ?> <?php else: ?> checked <?php endif; ?> >
                                    
                                </div>
                                <div class="layui-form-mid layui-word-aux">如果设置了百分比提现时计算为(提现金额*提现费率/100)</div>
                                
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">绿色能源是否开启</label>
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="green_flag" value="1" title="是" <?php if(isset($setting['green_flag'])): ?> <?php echo e($setting['green_flag'] == 1 ? 'checked' : ''); ?> <?php endif; ?> >
                                    <input type="radio" name="green_flag" value="0" title="否" <?php if(isset($setting['green_flag'])): ?> <?php echo e($setting['green_flag'] == 0 ? 'checked' : ''); ?> <?php else: ?> checked <?php endif; ?> >
                                </div>
                                
                            </div>
                        </div>
                        <!--<div class="layui-form-item">-->
                        <!--    <label class="layui-form-label">智能合约利息是否每日发放</label>-->
                        <!--    <div class="layui-input-block">-->
                        <!--        <div class="layui-input-inline">-->
                        <!--            <input type="radio" name="hy_lx_flag" value="1" title="是" <?php if(isset($setting['hy_lx_flag'])): ?> <?php echo e($setting['hy_lx_flag'] == 1 ? 'checked' : ''); ?> <?php endif; ?> >-->
                        <!--            <input type="radio" name="hy_lx_flag" value="0" title="否" <?php if(isset($setting['hy_lx_flag'])): ?> <?php echo e($setting['hy_lx_flag'] == 0 ? 'checked' : ''); ?> <?php else: ?> checked <?php endif; ?> >-->
                        <!--        </div>-->
                        <!--        <div class="layui-form-mid layui-word-aux">否的话都是冻结在账户里面最后一天释放</div>-->
                        <!--    </div>-->
                        <!--</div>-->
