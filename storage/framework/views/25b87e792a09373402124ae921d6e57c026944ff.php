...
<?php $__env->startSection('page-content'); ?>
    ...
    <script type="text/html" id="housing_img">
        <a href="javascript:void(0);" onclick="showImg('<?php echo e($imageServerUrl); ?>{{d.housing_img}}')">查看</a>
    </script>
    <script type="text/html" id="income_certificate_img">
        <a href="javascript:void(0);" onclick="showImg('<?php echo e($imageServerUrl); ?>{{d.income_certificate_img}}')">查看</a>
    </script>
    <script type="text/html" id="bank_details_img">
        <a href="javascript:void(0);" onclick="showImg('<?php echo e($imageServerUrl); ?>{{d.bank_details_img}}')">查看</a>
    </script>
    <script type="text/html" id="id_img">
        <a href="javascript:void(0);" onclick="showImg('<?php echo e($imageServerUrl); ?>{{d.id_img}}')">查看</a>
    </script>
                ...
                window.onload = function() {
                    ...
                    layui.use(['element', 'form', 'layer', 'table','laydate'], function () {
                        ...
                        form.on('submit(mobile_search)',function(obj){
                            ...
                            tbRend("<?php echo e(url('/admin/loan/order_list')); ?>?user_id="+user_id
                        ...
                        tbRend("<?php echo e(url('/admin/loan/order_list')); ?>");
                        //监听工具条
