        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width:120px;">
                <select name="legal_id_dialog" id="legal_id_dialog" lay-verify="required">
                    <?php $__currentLoopData = $matchs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($currency -> id); ?>"><?php echo e($currency -> currency_name); ?> / <?php echo e($currency -> legal_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        </div>
        ...
        table.on('tool(data_table)', function (obj) {
            ...
            if (layEvent == 'handle2') {
                layer.confirm('确认要止盈平仓吗?', {
                    ...
                    $.ajax({
                        url:"<?php echo e(url('/admin/hazard/handle_y_new')); ?>",
                        type: 'POST',
                        data: {id:data.id},
            ...
            if (layEvent == 'handle5') {
                layer.confirm('确认要强制撤销吗?', {
                    ...
                    $.ajax({
                        url:"<?php echo e(url('/admin/hazard/handle_new1')); ?>",
                        type: 'POST',
                        data: {id:data.id},
                        success: function (res) {
                            layer.msg(res.message);
            ...
            if (layEvent == 'handle') {
                layer.confirm('确认要强制平仓吗?', {
                    ...
                    $.ajax({
                        url:"<?php echo e(url('/admin/hazard/handle_new')); ?>",
                        type: 'POST',
                        data: {id:data.id},
                        success: function (res) {
                            layer.msg(res.message);
            ...
            if (layEvent == 'handle3') {
                layer.confirm('确认要止损平仓吗?', {
                    ...
                    $.ajax({
                        url:"<?php echo e(url('/admin/hazard/handle_c_new')); ?>",
                        type: 'POST',
                        data: {id:data.id},
                        success: function (res) {
                            layer.msg(res.message);
