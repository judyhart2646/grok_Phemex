 ...
 <form class="layui-form layui-form-pane layui-inline" action="">
    ...
    <div class="layui-inline" style="margin-left: 10px">
        <div class="layui-input-inline">
            ...
            <button class="layui-btn" lay-submit="" lay-filter="mobile_search"><i class="layui-icon layui-icon-refresh-3"></i></button>
...
<script type="text/html" id="system_flag">
<input type="checkbox" name="system_flag" value="{{d.id}}" lay-skin="switch" lay-text="是|否" lay-filter="system_flag" {{ d.system_flag == 1 ? 'checked' : '' }} >
</script>
    ...
    layui.use(['element', 'form', 'layer', 'table'], function () {
        ...
        var user_table = table.render({
            ...
            ,cols: [[
                ...
                // ,{field:'btc_totle', title:'BTC', minWidth:100}
                // ,{field:'eth_totle', title:'ETH', minWidth:100}
                // ,{field:'usdt_totle', title:'USDT', minWidth:100}
                ...
                ,{field:'system_flag', title:'是否系统账号', minWidth:120, templet: '#system_flag'}
        ...
        form.on('switch(system_flag)', function(obj){
            var id = this.value;
            
            $.ajax({
                url:'<?php echo e(url('admin/user/system_flag')); ?>',
                type:'post',
                dataType:'json',
                data:{user_id:id},
                success:function (res) {
