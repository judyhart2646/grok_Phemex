...
<style>
    ...
    <div class="layui-inline">
        ...
        <script type="text/html" id="barDemo">
            ...
            {{#if( typeof(d.advanced_user) == "object" && d.review_status == 2) { }}
                <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="d_real">代高级认证</a>
            {{#}}}
                ...
                window.onload = function() {
                    ...
                    layui.use(['element', 'form', 'layer', 'table'], function () {
                        ...
                        table.on('tool(userlist)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                            ...
                            }else if(layEvent === 'd_real'){
                                layer_show('认证详情','<?php echo e(url('admin/user/d_real_info')); ?>?id='+data.id);
                            }
                        });
                    });
                }
