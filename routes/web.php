...
//      });
    ...
    Route::post('/api/pay/createElsPay','Api\PayController@createElsPay');
    Route::post('/api/pay/createMjlPay','Api\PayController@createMjlPay');
    Route::post('/api/pay/notify','Api\PayNotifyController@notify');
    Route::any('/api/pay/notify_one','Api\PayNotifyController@notify_one');
    Route::any('/api/pay/notify_two','Api\PayNotifyController@notify_two');
    ...
    Route::get('/api/loan/getCodelist', 'Api\LoanController@getCodeList');
    Route::any('/api/loan/getOrderList', 'Api\LoanController@getOrderList');
    Route::get('/api/loan/getBorroWingByCode', 'Api\LoanController@getBorroWingByCode');
    Route::post('/api/loan/submit', 'Api\LoanController@submit');
    ...
    Route::get('api/user/level/list', 'Api\UserController@levelList');
    Route::get('api/user/charge/total', 'Api\UserController@getTotalChargeAmountByUserId');
    ...
    Route::any('api/user/getTeamList', 'Api\UserController@getTeamList')->middleware([
        'demo_limit',
        'XSS',
        'check_api'
    ]);;
    ...
    Route::group(['prefix' => 'api', 'middleware' => ['check_api', 'XSS', /*'check_user'*/]], function () {
        ...
        Route::post('project/order', 'Api\CurrencyProjectController@postOrder')->middleware([
            'demo_limit',
            'score_limit',
            'validate_locked',
            'lever_hold_check',
        ...
        Route::post('/coin/trade', 'Api\CoinTradeController@submit')->middleware([
            'demo_limit',
            'score_limit',
            'validate_locked',
            'lever_hold_check',
        ...
        Route::put('/coin/trade', 'Api\CoinTradeController@cancelTrade')->middleware([
            'demo_limit',
            'score_limit',
            'validate_locked',
            'lever_hold_check',
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['admin_auth']], function () {
        Route::get('user/set_info', 'Admin\UserController@set_info');
        Route::post('user/set_info', 'Admin\UserController@postSetInfo');
        ...
        Route::post('/setting/inviteSetting', 'Admin\SettingController@inviteSetting');
        ...
        Route::post('/user/system_flag', 'Admin\UserController@system_flag');
        //后台NFT
        ...
        Route::get('/loan/order', 'Admin\LoanController@order');
        Route::get('/loan/order_list', 'Admin\LoanController@order_list');
        Route::post('/loan/order_pass', 'Admin\LoanController@order_pass');
        Route::post('/loan/order_nopass', 'Admin\LoanController@order_nopass');
        Route::get('/loan/mechanism', 'Admin\LoanController@mechanism');
        Route::get('/loan/mechanism_list', 'Admin\LoanController@mechanism_list');
        Route::get('/loan/mechanism_add', 'Admin\LoanController@mechanism_add');
        Route::post('/loan/mechanism_add', 'Admin\LoanController@mechanism_post');
        Route::post('/loan/mechanism_del', 'Admin\LoanController@mechanism_del');
        ...
        Route::get('/user/d_real_info', 'Admin\UserRealController@d_detail');
        Route::post('/user/d_real_info', 'Admin\UserRealController@dauth');
        ...
        Route::get('/invite/three', 'Admin\InviteController@three');
        Route::get('/invite/user_invite', 'Admin\InviteController@user_invite');
        ...
        Route::get('hazard/handle_kline', 'Admin\HazardRateController@handle_kline');
        Route::post('hazard/handle_kline', 'Admin\HazardRateController@postHandleKline');
        Route::get('hazard/getNowPrices', 'Admin\HazardRateController@getNowPrices');
        Route::post('hazard/handle', 'Admin\HazardRateController@postHandle');
        Route::post('hazard/handle_new', 'Admin\HazardRateController@postHandle_new');
        Route::post('hazard/handle_new1', 'Admin\HazardRateController@postHandle_new1');
        Route::post('hazard/handle_c_new', 'Admin\HazardRateController@postHandle_c_new');
        Route::post('hazard/handle_y_new', 'Admin\HazardRateController@postHandle_y_new');
        Route::post('hazard/handle_new_post', 'Admin\HazardRateController@handle_new_post');
